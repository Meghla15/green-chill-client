...
const PurchasePage = () => {
    ...
    return (
        <div className='border w-2/3 py-8 container mx-auto bg-gray-100 mt-14 mb-48'>
        <h1 className='text-center text-orange-600 font-bold text-3xl p-4'>Purchase Now </h1>


        <section className="p-6  text-gray-900">
<form onSubmit={handlePurchase} noValidate="" action="" className="container flex flex-col mx-auto space-y-12">
    <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
        ...
        <div className="grid grid-cols-8 gap-4 col-span-full lg:col-span-4">
            ...
            <label className="text-xm font-semibold">User Email</label>
                ...
                placeholder="User Email" className=" p-2 text-green-600 w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
            </div>
