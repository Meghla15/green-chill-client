          ...
          <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
            ...
            <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
              ...
              <div className="flex gap-12 mt-6">
                <button className="rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-orange-600 text-orange-600 ">
               ...
               <Link to='/'> <button className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-orange-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-100 group">
