...
const TopFoodSection = () => {
    ...
    return (
        <div className='container mx-auto'>
         <h1 className='font-sens font-bold lg:text-4xl text-2xl text-center text-orange-600 animate__animated animate__bounceInLeft'>Our Top Foods</h1>
        ...
        <div className='container  mx-auto grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-4 md:gap-2 gap-2 lg:mt-10 mt-6 mb-16 px-4 lg:px-0 md:px-2 'data-aos ="fade-right"  >
            {
